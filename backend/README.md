...
## Project Structure
    ...
    ├── testapiautostoryboa_73303  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_73303`
...
2. Clone this repo and `cd testapiautostoryboa_73303`
